...
$lang['about_app'] = 'Tietoja BullPlanner:sta';
...
$lang['about_app_info'] = 'BullPlanner on web-sovellus jonka avulla asiakkaasi voivat varata aikoja netissä. Lisäominaisuutena on mahdollisuus synkronoida tapaamiset Google-kalenteriin, jolloin varaustietojen käyttö muissa palveluissa on helppoa.';
$lang['current_version'] = 'Tämänhetkinen versio';
$lang['support'] = 'Tuki';
$lang['about_app_support'] = 'Jos kohtaat ongelmia BullPlannerin käytössä voit etsiä tietoa virallisesta Google-ryhmästä. Myös GitHub sivuston kautta voit olla mukana kehityksessä.';
...
$lang['about_app_license'] = 'BullPlanner on GPLv3 lisensoitu. Käyttämällä BullPlanneria palvelutuotannossa tai muilla lisenssissä mainituilla tavoilla suostut linkissä oleviin lisenssiehtoihin:';
...
$lang['ea_update_success'] = 'BullPlanner päivitettiin onnistuneesti.';
...
$lang['api_token_hint'] = 'Aseta secret token aktivoidaksesi token-pohjaisen autentikoinnin BullPlanner API:lle.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'Tämä mahdollistaa kaiken BullPlanner -datan käsittelyn HTTP-protokollan ja API-rajapinnan kautta. Tällä voit luoda omia integraatioita järjestelmään.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Tämä integrointi mahdollistaa käyttäjien yhdistämisen olemassa olevaan LDAP-palvelimeen. Käyttäjät tuodaan automaattisesti BullPlanner:iin, jolloin he voivat kirjautua AD-tunnuksillaan (käyttäjänimen tulee olla sama).';
$lang['host'] = 'Isäntä';
$lang['port'] = 'Portti';
