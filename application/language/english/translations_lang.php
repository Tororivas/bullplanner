...
$lang['service_and_provider'] = 'Class & Coach';
$lang['select_service'] = 'Select Class';
$lang['select_provider'] = 'Select Coach';
...
$lang['manage_appointment_record_hint'] = 'Manage all the appointment records of the available coaches and services.';
$lang['select_filter_item_hint'] = 'Select a coach or a class and view the appointments on the calendar.';
...
$lang['manage_users_hint'] = 'Manage the backend users (admins, coaches, secretaries).';
$lang['settings_hint'] = 'Set system and user settings.';
$lang['log_out_hint'] = 'Log out of the system.';
$lang['unavailability_periods_hint'] = 'During unavailability periods the coach won\'t accept new appointments.';
...
$lang['sunday'] = 'Sunday';
$lang['breaks'] = 'Breaks';
$lang['add_breaks_during_each_day'] = 'Add the working breaks during each day. During breaks the coach will not accept any appointments.';
$lang['day'] = 'Day';
$lang['days'] = 'Days';
...
$lang['about_app'] = 'About BullPlanner';
$lang['edit_working_plan_hint'] = 'Mark below the days and hours that your company will accept appointments. You will be able to adjust appointments in non-working hours but the customers will not be able to book appointments by themselves in non-working periods. This working plan will be the default for every new coach record, but you will be able to change each coach\'s plan separately by editing his record. After that you can add break periods.';
$lang['edit_breaks_hint'] = 'Add the working breaks during each day. These breaks will be applied for all new coaches.';
...
$lang['about_app_info'] = 'BullPlanner is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using BullPlanner you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'BullPlanner is licensed under the GPLv3 license. By using the code of BullPlanner in any way you are agreeing to the terms described in the following url:';
...
$lang['delete_provider'] = 'Delete Coach';
...
$lang['ea_update_success'] = 'BullPlanner has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the BullPlanner API.';
$lang['timezone'] = 'Timezone';
$lang['overwrite_existing_working_plans'] = 'This will overwrite the existing coach working plans, are you sure that you want to continue?';
$lang['working_plans_got_updated'] = 'All the working plans got updated.';
$lang['apply_to_all_providers'] = 'Apply To All Coaches';
$lang['display_any_provider'] = 'Display Any Coach Option';
$lang['display_any_provider_hint'] = 'The booking page will get an additional option that allows customers to book without specifying a coach.';
...
$lang['limit_customer_access_hint'] = 'If enabled, coaches and secretaries will only be able to access customers they have an appointment with.';
$lang['url'] = 'URL';
...
$lang['provider_save'] = 'Coach Save';
$lang['provider_delete'] = 'Coach Delete';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the BullPlanner data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['year'] = 'Year';
$lang['make_non_working_day'] = 'This coach will not be available for work on the selected day.';
...
$lang['blocked_periods_hint'] = 'Define periods of time where public bookings will be disabled for all coaches (e.g. closed dates, holidays etc.).';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into BullPlanner and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
