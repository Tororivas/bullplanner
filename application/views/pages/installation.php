...
<head>
    ...
    <title>Installation | BullPlanner</title>
...
<header>
    <div class="container">
        <h1 class="page-title">BullPlanner Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the BullPlanner installation page.</h3>
        <p>
            This page will help you set the main settings of your BullPlanner installation. You will be able to
            ...
            If you face any problems during the usage of BullPlanner you can always check the
            <a href="https://bullplanner.com/docs.html">Documentation</a> and
            <a href="https://groups.google.com/group/easy-appointments">Support Group</a> for getting help. You may also
            submit new issues on
            <a href="https://github.com/tororivas/bullplanner/issues">GitHub Issues</a>
    ...
    <div class="mb-2">
        <h3>License</h3>
        BullPlanner is licensed under the <span class="badge bg-secondary">GPL-3.0 license</span>. By using the
        code
        of BullPlanner in any way <br> you agree with the terms described in the following url:
...
<footer>
    Powered by <a href="https://bullplanner.com">BullPlanner</a>
</footer>
